...
<div data-role="page" id="favi">
	<div data-role="header" class="nav-glyphish-example" data-theme="b" data-position="fixed">
	    ...
	    <ul>
	        ...
	        <li><a href="<?=$this->commonurl;?>comp" id="comp" data-icon="shop" class="ui-btn-active">Company</a></li>
	...
	<div date-role="content">
		<ul data-role="listview" ata-inset="true">
		    <li data-role="list-divider">Ticketmonster</li>
		    <? foreach($cs as $k => $v) { ?>
