...
foreach($list as $k => $v) {
?>
    <li><a href="#"><span class="ui-li-heading" style="font-size:12pt;<?=(($v['plusminus'] == '+')? "color:#00F" : "color:#F00");?>"><?=$v['plusminus'];?> <?=number_format($v['money']);?> = <?=number_format($last);?></span><span class="ui-li-desc"><?=substr($v['regdate'],2,8);?> : <?=$v['comment'];?></span></a></li>
