    <div class="jumbotron signpage">
        ...
        <table>
            <tr>
                ...
                <td width="260"><input type="text" name="mail" id="mail" value="" class="form-control" onfocus="resetst('mail');" onfocusout="Valid.mail(this);"></td>
            ...
            <tr>
                <td>이름</td>
                <td><input type="text" name="name" id="name" value="" class="form-control" onfocus="resetst('name');"></td>
...
var Valid = new function() {
    this.mail = function(inp) {
        var mail = $(inp).val();
    }

    this.pwd = function(inp) {
        var pwd = $(inp).val();
    }

    this.names = function(inp) {
        var names = $(inp).val();
    }
}
