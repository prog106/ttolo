...
class Project extends CI_Controller {
    function __construct() {
        ...
        //$this->load->model('biz/Projectmodelbiz', 'model');
        $this->isUseLayout = false;
        $this->_user = ($this->input->cookie('ttolokr_projectuser')) ? $this->input->cookie('ttolokr_projectuser') : null;
    }
    ...
    public function googlemap() {
        ...
        $data['description'] = " googlemap test";
        $data['url'] = "googlemap";
        $this->load->view('project/googlemap',$data);
    }
