...
class Welcome extends CI_Controller {
	...
	public function index()
	{
        ...
        $data['ms'] = array(
            '로또 추첨기' => 'http://ttolo.kr/lt',
            '개인링크' => 'http://ttolo.kr/go',
            '정총무' => 'http://ttolo.kr/money',
            '같이밥먹기' => 'http://ttolo.kr/lt/swap',
        );
    ...
    public function rss()
    {
        ...
        /*$text = file_get_contents('http://www.ticketmonster.co.kr/');
        print_r($text);
        die;
        preg_match_all("/<.*?>/is", $txt, $out);
        print_r($out);
        die;*/
//        $rsshost['www'] = "http://www.ticketmonster.co.kr/";
        $rsshost['www'] = "http://login.ticketmonster.co.kr/";
